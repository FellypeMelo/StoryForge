...
describe('AcademicDiscipline Value Object', () => {
  ...
  it('should throw error if value is null or undefined', () => {
    expect(() => AcademicDiscipline.create(null as any)).toThrow('Academic discipline cannot be empty');
    expect(() => AcademicDiscipline.create(undefined as any)).toThrow('Academic discipline cannot be empty');
  });
});
