...
export class LocationId extends Id {
  ...
  public static generate(): LocationId { return new LocationId(crypto.randomUUID()); }
}
...
export class WorldRuleId extends Id {
  ...
  public static generate(): WorldRuleId { return new WorldRuleId(crypto.randomUUID()); }
}
...
export class TimelineEventId extends Id {
  ...
  public static generate(): TimelineEventId { return new TimelineEventId(crypto.randomUUID()); }
}
...
export class RelationshipId extends Id {
  ...
  public static generate(): RelationshipId { return new RelationshipId(crypto.randomUUID()); }
}
