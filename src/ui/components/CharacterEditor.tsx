  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-2">
            <label htmlFor="name" className="text-xs font-medium text-text-muted">Name</label>
            <input 
              id="name"
              name="name"
              type="text"
          ...
          <div className="space-y-2">
            <label htmlFor="age" className="text-xs font-medium text-text-muted">Age</label>
            <input 
              id="age"
              name="age"
              type="number"
          ...
          <div className="md:col-span-3 space-y-2">
            <label htmlFor="occupation" className="text-xs font-medium text-text-muted">Occupation</label>
            <input 
              id="occupation"
              name="occupation"
              type="text"
          ...
          <div className="md:col-span-3 space-y-2">
            <label htmlFor="physical_description" className="text-xs font-medium text-text-muted">Physical Description</label>
            <textarea 
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-3 text-text-muted">
          <Brain size={18} />
          <h3 className="text-xs font-bold tracking-widest uppercase">Psychological Profile (OCEAN)</h3>
        </div>
          ...
          {oceanTraits.map(trait => (
            <div key={trait.key} className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs font-mono text-text-muted">{formData.ocean_scores[trait.key]}%</span>
              </div>
              <input 
                type="range"
                min="0"
      ...
      <section className="space-y-6 pb-12">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <label htmlFor="goal" className="text-xs font-medium text-text-muted">Concrete Goal</label>
            <input 
              id="goal"
              name="goal"
              type="text"
          ...
          <div className="space-y-2">
            <label htmlFor="motivation" className="text-xs font-medium text-text-muted">Motivation</label>
            <input 
              id="motivation"
              name="motivation"
              type="text"
          ...
          <div className="space-y-2">
            <label htmlFor="internal_conflict" className="text-xs font-medium text-text-muted">Internal Conflict (The Wound)</label>
            <textarea 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <div className="space-y-2">
              <label htmlFor="voice" className="text-xs font-medium text-text-muted">Voice & Diction</label>
              <input 
                id="voice"
                name="voice"
                type="text"
            ...
            <div className="space-y-2">
              <label htmlFor="mannerisms" className="text-xs font-medium text-text-muted">Mannerisms</label>
              <input 
                id="mannerisms"
                name="mannerisms"
                type="text"
