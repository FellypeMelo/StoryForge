    ...
    <form onSubmit={handleSubmit} className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
      <div className="flex justify-between items-center sticky top-0 bg-bg-base/80 backdrop-blur-md py-4 z-20 border-b border-border-subtle">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-xl font-serif text-text-main">Location Details</h2>
        </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3 text-text-muted">
          <MapPin size={18} />
          <h3 className="text-xs font-bold tracking-widest uppercase">Setting Information</h3>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor="description" className="text-xs font-medium text-text-muted">Description</label>
          ...
          <div className="space-y-2">
            <label htmlFor="symbolicMeaning" className="text-xs font-medium text-text-muted">Symbolic Meaning</label>
            <input id="symbolicMeaning" name="symbolicMeaning" type="text" value={formData.symbolicMeaning} onChange={handleChange} className="w-full bg-bg-hover border border-border-subtle p-3 rounded text-text-main focus:border-text-main outline-none" placeholder="What does this place represent?" />
          </div>
        </div>
      </div>
    </form>
