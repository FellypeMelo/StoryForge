        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="md:col-span-3 space-y-2">
              <label htmlFor="category" className="text-xs font-medium text-text-muted">
                Categoria
              </label>
              <input
                id="category"
            ...
            <div className="space-y-2">
              <label htmlFor="hierarchy" className="text-xs font-medium text-text-muted">
                Hierarquia
              </label>
              <input
                id="hierarchy"
          ...
          <div className="space-y-2">
            <label htmlFor="content" className="text-xs font-medium text-text-muted">
              Conteúdo da Regra
            </label>
            <textarea
              id="content"
