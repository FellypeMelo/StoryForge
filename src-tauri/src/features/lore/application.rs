...
impl<'a> LoreService<'a> {
    ...
    pub fn get_location(&self, id: LocationId) -> AppResult<Location> {
        self.location_repo.get_location_by_id(&id)
    }

    pub fn update_location(&self, location: Location) -> AppResult<()> {
        self.location_repo.update_location(&location)
    }

    pub fn delete_location(&self, id: LocationId) -> AppResult<()> {
        self.location_repo.delete_location(&id)
    }
    ...
    pub fn get_world_rule(&self, id: WorldRuleId) -> AppResult<WorldRule> {
        self.rule_repo.get_world_rule_by_id(&id)
    }

    pub fn update_world_rule(&self, rule: WorldRule) -> AppResult<()> {
        self.rule_repo.update_world_rule(&rule)
    }

    pub fn delete_world_rule(&self, id: WorldRuleId) -> AppResult<()> {
        self.rule_repo.delete_world_rule(&id)
    }
    ...
    pub fn list_global_timeline_events(
        &self,
        project_id: ProjectId,
    ...
    pub fn move_timeline_event_to_book(
        &self,
        id: TimelineEventId,
        book_id: BookId,
    ) -> AppResult<()> {
        self.timeline_repo
            .move_timeline_event_to_book(&id, &book_id)
    }
    ...
    pub fn list_global_relationships(&self, project_id: ProjectId) -> AppResult<Vec<Relationship>> {
        self.relationship_repo
            .list_global_relationships(&project_id)
    }
    ...
    pub fn move_relationship_to_book(&self, id: RelationshipId, book_id: BookId) -> AppResult<()> {
        self.relationship_repo
            .move_relationship_to_book(&id, &book_id)
    }
    ...
    pub fn get_blacklist_entry(&self, id: BlacklistEntryId) -> AppResult<BlacklistEntry> {
        self.blacklist_repo.get_blacklist_entry_by_id(&id)
    }

    pub fn list_blacklist_entries_by_book(
        &self,
        book_id: BookId,
    ...
    pub fn list_global_blacklist_entries(
        &self,
        project_id: ProjectId,
    ) -> AppResult<Vec<BlacklistEntry>> {
        self.blacklist_repo
            .list_global_blacklist_entries(&project_id)
    }
    ...
    pub fn move_blacklist_entry_to_book(
        &self,
        id: BlacklistEntryId,
        book_id: BookId,
    ) -> AppResult<()> {
        self.blacklist_repo
            .move_blacklist_entry_to_book(&id, &book_id)
    }
...
mod tests {
    ...
    use crate::domain::value_objects::{
        BlacklistEntryId, CharacterId, LocationId, RelationshipId, TimelineEventId, WorldRuleId,
    };

    struct MockRepo;

    impl LocationRepository for MockRepo {
        fn create_location(&self, _location: &Location) -> AppResult<()> {
            Ok(())
        }
        ...
        fn list_locations_by_project(&self, _project_id: &ProjectId) -> AppResult<Vec<Location>> {
            Ok(vec![])
        }
        fn list_locations_by_book(&self, _book_id: &BookId) -> AppResult<Vec<Location>> {
            Ok(vec![])
        }
        fn list_global_locations(&self, _project_id: &ProjectId) -> AppResult<Vec<Location>> {
            Ok(vec![])
        }
        fn move_location_to_book(&self, _id: &LocationId, _book_id: &BookId) -> AppResult<()> {
            Ok(())
        }
        fn move_location_to_project(&self, _id: &LocationId) -> AppResult<()> {
            Ok(())
        }
        fn update_location(&self, _location: &Location) -> AppResult<()> {
            Ok(())
        }
        fn delete_location(&self, _id: &LocationId) -> AppResult<()> {
            Ok(())
        }
    }

    impl WorldRuleRepository for MockRepo {
        fn create_world_rule(&self, _rule: &WorldRule) -> AppResult<()> {
            Ok(())
        }
        ...
        fn list_world_rules_by_project(
            &self,
            _project_id: &ProjectId,
        ) -> AppResult<Vec<WorldRule>> {
            Ok(vec![])
        }
        fn list_world_rules_by_book(&self, _book_id: &BookId) -> AppResult<Vec<WorldRule>> {
            Ok(vec![])
        }
        fn list_global_world_rules(&self, _project_id: &ProjectId) -> AppResult<Vec<WorldRule>> {
            Ok(vec![])
        }
        fn move_world_rule_to_book(&self, _id: &WorldRuleId, _book_id: &BookId) -> AppResult<()> {
            Ok(())
        }
        fn move_world_rule_to_project(&self, _id: &WorldRuleId) -> AppResult<()> {
            Ok(())
        }
        fn update_world_rule(&self, _rule: &WorldRule) -> AppResult<()> {
            Ok(())
        }
        fn delete_world_rule(&self, _id: &WorldRuleId) -> AppResult<()> {
            Ok(())
        }
    }

    impl TimelineRepository for MockRepo {
        fn create_timeline_event(&self, _event: &TimelineEvent) -> AppResult<()> {
            Ok(())
        }
        ...
        fn list_timeline_events_by_book(&self, _book_id: &BookId) -> AppResult<Vec<TimelineEvent>> {
            Ok(vec![])
        }
        fn list_global_timeline_events(
            &self,
            _project_id: &ProjectId,
        ) -> AppResult<Vec<TimelineEvent>> {
            Ok(vec![])
        }
        fn move_timeline_event_to_book(
            &self,
            _id: &TimelineEventId,
            _book_id: &BookId,
        ) -> AppResult<()> {
        ...
        fn move_timeline_event_to_project(&self, _id: &TimelineEventId) -> AppResult<()> {
            Ok(())
        }
        fn update_timeline_event(&self, _event: &TimelineEvent) -> AppResult<()> {
            Ok(())
        }
        fn delete_timeline_event(&self, _id: &TimelineEventId) -> AppResult<()> {
            Ok(())
        }
    }

    impl RelationshipRepository for MockRepo {
        fn create_relationship(&self, _rel: &Relationship) -> AppResult<()> {
            Ok(())
        }
        ...
        fn list_relationships_by_book(&self, _book_id: &BookId) -> AppResult<Vec<Relationship>> {
            Ok(vec![])
        }
        fn list_global_relationships(
            &self,
            _project_id: &ProjectId,
        ) -> AppResult<Vec<Relationship>> {
            Ok(vec![])
        }
        fn move_relationship_to_book(
            &self,
            _id: &RelationshipId,
            _book_id: &BookId,
        ) -> AppResult<()> {
        ...
        fn move_relationship_to_project(&self, _id: &RelationshipId) -> AppResult<()> {
            Ok(())
        }
        fn update_relationship(&self, _relationship: &Relationship) -> AppResult<()> {
            Ok(())
        }
        fn delete_relationship(&self, _id: &RelationshipId) -> AppResult<()> {
            Ok(())
        }
    }

    impl BlacklistRepository for MockRepo {
        fn create_blacklist_entry(&self, _entry: &BlacklistEntry) -> AppResult<()> {
            Ok(())
        }
        ...
        fn list_blacklist_entries_by_book(
            &self,
            _book_id: &BookId,
        ) -> AppResult<Vec<BlacklistEntry>> {
            Ok(vec![])
        ...
        fn move_blacklist_entry_to_project(&self, _id: &BlacklistEntryId) -> AppResult<()> {
            Ok(())
        }
        fn update_blacklist_entry(&self, _entry: &BlacklistEntry) -> AppResult<()> {
            Ok(())
        }
        fn delete_blacklist_entry(&self, _id: &BlacklistEntryId) -> AppResult<()> {
            Ok(())
        }
    }
    ...
    #[test]
    fn test_lore_service_location_get_update_delete() {
        let mock = MockRepo;
        let service = LoreService::new(&mock, &mock, &mock, &mock, &mock, &mock);
        let location = Location::new(ProjectId("p".to_string()), None, "L".to_string()).unwrap();

        assert!(service.get_location(LocationId::new()).is_ok());
        assert!(service.update_location(location).is_ok());
        assert!(service.delete_location(LocationId::new()).is_ok());
    }

    #[test]
    fn test_lore_service_world_rule_get_update_delete() {
        let mock = MockRepo;
        let service = LoreService::new(&mock, &mock, &mock, &mock, &mock, &mock);
        ...
        assert!(service.get_world_rule(WorldRuleId::new()).is_ok());
        assert!(service.update_world_rule(rule).is_ok());
        assert!(service.delete_world_rule(WorldRuleId::new()).is_ok());
    }

    #[test]
    fn test_lore_service_blacklist_get() {
        let mock = MockRepo;
        let service = LoreService::new(&mock, &mock, &mock, &mock, &mock, &mock);

        assert!(service.get_blacklist_entry(BlacklistEntryId::new()).is_ok());
    }
    ...
    fn test_lore_service_location_ops() {
        ...
        assert!(service
            .create_location(pid.clone(), None, "L".to_string())
            .is_ok());
        ...
        assert!(service
            .move_location_to_book(LocationId::new(), BookId::new())
            .is_ok());
    ...
    fn test_lore_service_world_rule_ops() {
        ...
        assert!(service
            .create_world_rule(pid.clone(), None, "C".to_string(), "Co".to_string())
            .is_ok());
        ...
        assert!(service
            .move_world_rule_to_book(WorldRuleId::new(), BookId::new())
            .is_ok());
        assert!(service
            .move_world_rule_to_project(WorldRuleId::new())
            .is_ok());
    }
    ...
    fn test_lore_service_blacklist_ops() {
        ...
        assert!(service
            .create_blacklist_entry(pid.clone(), None, "T".to_string())
            .is_ok());
        assert!(service
            .list_blacklist_entries_by_book(BookId::new())
            .is_ok());
        assert!(service.list_global_blacklist_entries(pid).is_ok());
        assert!(service
            .delete_blacklist_entry(BlacklistEntryId::new())
            .is_ok());
    }
}
